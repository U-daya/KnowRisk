...
export default function Sidebar({ components, selectedId, onSelect }: Props) {
  ...
  return (
    <aside className="w-[260px] flex-shrink-0 flex flex-col border-r border-zinc-800 bg-zinc-950">
      <div className="px-3 pt-3 pb-2 flex items-baseline gap-2 border-b border-zinc-800">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[12px] text-zinc-300 truncate">{c.name}</div>
                <div className="text-[10px] text-zinc-500">
                  {c.country} · T{c.tier}
                </div>
              </div>
              <div className="text-[11px] tabular-nums text-zinc-500 flex-shrink-0">
